...
/* motrar y filtrar tabla alumnos */    
$tbl_alu="SELECT p.* , pt.nom_classe
 FROM tbl_alumne p 
 INNER JOIN tbl_classe pt 
ON p.classe=pt.id_classe; ";
$tbl1 = mysqli_query($con,$tbl_alu);

if (isset($_POST['mostrar'])) {
$encontrar=$_POST['buscar'];
$filtro1="SELECT p.* , pt.nom_classe
FROM tbl_alumne p 
INNER JOIN tbl_classe pt 
ON p.classe=pt.id_classe WHERE `cognom1_alu` LIKE '%$encontrar%' OR `cognom2_alu` LIKE '%$encontrar%' OR `nom_alu` LIKE '%$encontrar%' OR `telf_alu` LIKE '%$encontrar%' OR `email_alu` LIKE '%$encontrar%' OR `dni_alu` LIKE '%$encontrar%' OR `nom_classe` LIKE '%$encontrar%';";
$tbl1=mysqli_query($con, $filtro1);
}

/* motrar y filtrar tabla profesores */   
 $tbl_prof="SELECT p.* , pt.nom_dept
 FROM tbl_professor p 
 INNER JOIN tbl_dept pt 
ON p.dept=pt.id_dept;";
$tbl2 = mysqli_query($con,$tbl_prof);

if (isset($_POST['mostrar2'])) {
$encontrar=$_POST['buscar2'];
$filtro2="SELECT p.* , pt.nom_dept
FROM tbl_professor p 
INNER JOIN tbl_dept pt  
ON p.dept=pt.id_dept WHERE `nom_prof` LIKE '%$encontrar%' OR `cognom1_prof` LIKE '%$encontrar%' OR `cognom2_prof` LIKE '%$encontrar%' OR `email_prof` LIKE '%$encontrar%' OR `telf` LIKE '%$encontrar%' OR `dept` LIKE '%$encontrar%';";
$tbl2=mysqli_query($con, $filtro2);
            ...
            <section id="menuNavegacion">
                <nav class="navbar navbar-dark bg-dark">
                    <div class="container-fluid">
                        ...
                        <form enctype="multipart/form-data" action="tabla.php?id=busqueda" method="post">
                <input type="text" class="color" id="buscar" name="buscar" placeholder="Buscar" style="width: 300px;">
                <input type="submit" class="boton btn-success btn-lg" name="mostrar" style="width: 100px;">
            </form>
                ...
                <div class="container"> 
                    ...
                    <table class="table table-striped table-condensed table-bordered">   
                        ...
                        <tr>     
                            ...
                            <td><button class="btn btn-danger" onClick="window.location.href='./cambios/borrarUsuario.php?id=<?php echo $row['id_alumne']; ?>';" >Borrar</button></td>
                            <td><button class="btn btn-success" onClick="window.location.href='./cambios/modificarUsuarioAlumno.php?id=<?php echo $row['id_alumne']; ?>';" >Modificar</button></td>
                            <td><button class="btn btn-success" onClick="window.location.href='./cambios/correoalu.php?id=<?php echo $row['id_alumne']; ?>';" >Correo</button></td>
                    ...
                    <table class="table table-striped table-condensed table-bordered">   
                            ...
                            ?>     
                                <tr>     
                                    ...
                                    <td><button class="btn btn-success" onClick="window.location.href='./cambios/correoprof.php?id=<?php echo $row['id_professor']; ?>';" >Correo</button></td>
