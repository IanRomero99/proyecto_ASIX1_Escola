...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="../proc/valida.js"></script>
        <script type="text/javascript" src="../proc/valida1.js"></script>
        <!-- TITULO -->
        ...
        <section id="menuNavegacion">
            <nav class="navbar fixed-top  navbar-dark bg-dark">
                <div class="container-fluid row">
                    ...
                    <a href="#" class="column-4" id="user_1">Profesor</a>
                    <a href="#" class="column-4" id="user_2">Administrador</a>
                </div>
            </nav>
        </section>
            ...
            <div id="cont_1">
                ...
                <div id="contenedor">
                    <div id="contInformacion">
                        ...
                        <div id="informacion">
                            <div class="form">
                            <form action="./proc/login.php" method="post" onsubmit="return validaFormulario();">
                                    <input type="text" placeholder="nombre" name="nom" class="input nombre" id="nom" oninput="this.style.backgroundColor='white'" >
                                    <input type="text" placeholder="correo" name="correo" class="input correo" id="correo" >
                                    <input type="password" placeholder="contraseña" name="pwd" class="input correo" id="pwd" >
                                    <br>
                                    <br>
                                    <div id="boton">
            ...
            <div id="cont_2" style="display: none;">
                ...
                <div id="contenedor">
                    <div id="contInformacion">
                        ...
                        <div id="informacion">
                            <div class="form">
                            <form action="./proc/login.php" method="post" onsubmit="return valida1Formulario();">
                                    <input type="text" placeholder="nombre" name="nom" class="input nombre" id="nom" oninput="this.style.backgroundColor='white'" >
                                    <input type="text" placeholder="correo" name="correo" class="input correo" id="correo" >
                                    <input type="password" placeholder="contraseña" name="pwd" class="input correo" id="pwd" >
                                    <br>
